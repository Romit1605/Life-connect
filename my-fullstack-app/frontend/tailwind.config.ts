  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        medicine: {
          DEFAULT: "hsl(var(--medicine))",
          foreground: "hsl(var(--medicine-foreground))",
        },
        ngo: {
          DEFAULT: "hsl(var(--ngo))",
          foreground: "hsl(var(--ngo-foreground))",
        },
        government: {
        ...
        alertYellow: "hsl(var(--alert-yellow))",
        alertOrange: "hsl(var(--alert-orange))",
        alertRed: "hsl(var(--alert-red))",
        sidebar: {
